<x-guest-layout>
    <div>
        <div class="w-full flex flex-col items-center py-24 bg-gray-50 h-fit">
            <h1 class="text-5xl font-light">We are IAB</h1>
            <h2 class="text-xl py-6">Hfdkhfjkadhfjahsfj ajkshfjksfahfjh </h2>
            <div class="self-start grid grid-cols-2 mx-48 gap-8 ">
                    <x-illustrations.about.hero.microscopy-scratch-concept-chemical className="h-full text-secondary-color"/>
        ...
        <div class="text-gray-50">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
                <path fill="currentColor" fill-opacity="1" d="M0,160L80,144C160,128,320,96,480,106.7C640,117,800,171,960,197.3C1120,224,1280,224,1360,224L1440,224L1440,0L1360,0C1280,0,1120,0,960,0C800,0,640,0,480,0C320,0,160,0,80,0L0,0Z"></path>
            </svg>
        </div>
    </div>
